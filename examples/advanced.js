...
controller.on('frame', function(frame) {
      ...
      if (typeof carobject !== 'undefined' && (object_grip == false || frame.hands[0] == undefined) && carobject.position.y > 50) {
        if (carobject.position.y < 60){
            carobject.position.y = carobject.position.y - 1;
        } else {
